...
import FundSearch from '../groups/group_search';
import FundForm from '../groups/group_form';

class PersonFundForm extends React.Component {
  static propTypes = {
  ...
  constructor(props){
    ...
    this.state = {
      person_fund: this.copy(this.props.person_fund)
    }
  ...
  handleChange(e){
    ...
    this.setState(prevState => {
      prevState.person_fund[name] = value;
      return prevState;
    });
  }
  ...
  handleDelete(e){
    ...
    fetch("/person_funds/"+this.props.person_fund.id, {
      method: 'DELETE',
  ...
  /** 
   * Handler invoked by PersonSearch and PersonForm component which sets the associated person id.
   ...
   */
  valid(){
    let person_fund = this.state.person_fund;
    return true;
  }
   ...
   * @public
   */
  renderPersonSelector(className, id){
    return (
   ...
   * @public
   */
  renderGroupSelector(className, id){
    return (
      <div className={className} id={id}>
  ...
  render(){
    ...
    let title = null;
    if (action == "create"){
      title = "Creating A New PersonFund";
    } else if (action == "update"){
      title = "Editing " + "PersonFund";
    }
        ...
        <div className="card-body">
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="person_id" name="person_id" aria-describedby="person_id_help" value={person_fund.person_id} placeholder="Enter Person" onChange={this.handleChange}/>
              <small id="person_id_help" className="form-text text-muted">Help text placeholder.</small>
            </div>

            <div className="form-group">
              <label htmlFor="fund_id" className="font-weight-bold">Fund</label>
              <input type="text" className="form-control" id="fund_id" name="fund_id" aria-describedby="fund_id_help" value={person_fund.fund_id} placeholder="Enter Fund" onChange={this.handleChange}/>
              <small id="fund_id_help" className="form-text text-muted">Help text placeholder.</small>
            </div>
  ...
  componentWillReceiveProps(nextProps) {
    this.setState(prevState => {
      prevState.person_fund = (nextProps.person_fund ? this.copy(nextProps.person_fund) : this.defaults());
      return prevState;
    })
  }
}

export default PersonFundForm;