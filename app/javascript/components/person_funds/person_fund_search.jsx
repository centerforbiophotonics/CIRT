 ...
 */
class PersonFundSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/person_funds/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Person Fund name',
      value: this.state.search_text,
      onChange: this.handleChange
    };

    return (
      <div className="person_fund-search">
        <p className="small-indent">Search for an existing Person Fund</p>
        <Autosuggest
...
export default PersonFundSearch;
