...
class PersonConsultationForm extends React.Component {
  static propTypes = {
  ...
  constructor(props){
    ...
    this.state = {
      person_consultation: this.copy(this.props.person_consultation)
    }
  ...
  handleChange(e){
    ...
    this.setState(prevState => {
      prevState.person_consultation[name] = value;
      return prevState;
    });
  }
  ...
  handleDelete(e){
    ...
    if (confirm("Are you sure you want to delete this person_consultation?"))
      fetch("/person_consultations/"+this.props.person_consultation.id, {
        method: 'DELETE',
   ...
   */
  valid(){
    let person_consultation = this.state.person_consultation;
    return true;
  }
  ...
  render(){
    ...
    let title = null;
    if (action == "create"){
      title = "Creating A New PersonConsultation";
    } else if (action == "update"){
      title = "Editing " + "PersonConsultation";
    }
        ...
        <div className="card-body">
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="person_id" name="person_id" aria-describedby="person_id_help" value={person_consultation.person_id} placeholder="Enter Person" onChange={this.handleChange}/>
              <small id="person_id_help" className="form-text text-muted">Help text placeholder.</small>
            </div>

            <div className="form-group">
              <label htmlFor="consultation_id" className="font-weight-bold">Consultation</label>
              <input type="text" className="form-control" id="consultation_id" name="consultation_id" aria-describedby="consultation_id_help" value={person_consultation.consultation_id} placeholder="Enter Consultation" onChange={this.handleChange}/>
              <small id="consultation_id_help" className="form-text text-muted">Help text placeholder.</small>
            </div>
  ...
  componentWillReceiveProps(nextProps) {
    this.setState(prevState => {
      prevState.person_consultation = (nextProps.person_consultation ? this.copy(nextProps.person_consultation) : this.defaults());
      return prevState;
    })
  }
}

export default PersonConsultationForm;