 ...
 */
class PersonConsultationSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/person_consultations/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Person Consultation name',
    ...
    return (
      <div className="person_consultation-search">
        <p className="small-indent">Search for an existing Person Consultation</p>
        <Autosuggest
...
export default PersonConsultationSearch;
