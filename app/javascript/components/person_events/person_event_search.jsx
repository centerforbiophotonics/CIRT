 ...
 */
class PersonEventSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/events/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Person Event name',
      value: this.state.search_text,
      onChange: this.handleChange
    };

    return (
      <div className="person_event-search">
        <p className="small-indent">Search for an existing Person Event</p>
        <Autosuggest
...
export default PersonEventSearch;
