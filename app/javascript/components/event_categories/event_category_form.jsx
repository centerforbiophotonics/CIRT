...
class EventCategoryForm extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {
      event_category: this.copy(this.props.event_category)
    }
  ...
  handleChange(e){
    ...
    this.setState(prevState => {
      prevState.event_category[name] = value;
      return prevState;
    });
  }
  ...
  handleDelete(e){
    ...
    fetch("/event_categories/"+this.props.event_category.id, {
      method: 'DELETE',
   ...
   */
  valid(){
    let event_category = this.state.event_category;
    return true;
  }
  ...
  render(){
    ...
    let title = null;
    if (action == "create"){
      title = "Creating A New EventCategory";
    } else if (action == "update"){
      title = "Editing " + event_category.name;
    }
        ...
        <div className="card-body">
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="name" name="name" aria-describedby="name_help" value={event_category.name} placeholder="Enter Name" onChange={this.handleChange}/>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="description" name="description" aria-describedby="description_help" value={event_category.description} placeholder="Enter Description" onChange={this.handleChange}/>
  ...
  componentWillReceiveProps(nextProps) {
    this.setState(prevState => {
      prevState.event_category = (nextProps.event_category ? this.copy(nextProps.event_category) : this.defaults());
      return prevState;
    })
  }
}
