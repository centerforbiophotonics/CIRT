...
class EventCategories extends React.Component {
  static propTypes = {
    /** @type {object} A hash of event_category ids to objects containing their attributes and associated models' attributes. */
    event_categories: PropTypes.object,
  ...
  constructor(props){
    ...
    this.state = {
      ...
      event_categories: this.copy(props.event_categories),
  ...
  add(event_category) {
    this.setState(function(prevState, props){
      prevState.event_categories[event_category.id] = event_category;
  ...
  delete(event_category){
    this.setState(function(prevState, props){
      delete prevState.event_categories[event_category.id];
      prevState.selected = null;
      prevState.editing = false;
      return prevState;
    });
      ...
      <div className="event_categories col-md-12">
        ...
        <div className="card">
          ...
          <h4 className="text-center">
            (Filtered to {this.state.export_data.length} out of {Object.keys(this.state.event_categories).length})
          </h4>
          ...
          <div className="card-body">
            ...
            <ReactTable
              data={Object.values(this.state.event_categories)}
  ...
  componentWillReceiveProps(nextProps) {
    this.setState(prevState => {
      prevState.event_categories = this.copy(nextProps.event_categories);
      return prevState;
    })
  }
}
