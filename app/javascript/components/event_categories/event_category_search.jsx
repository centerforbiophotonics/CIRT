 ...
 */
class EventCategorySearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/event_categories/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Event Category name',
      value: this.state.search_text,
      onChange: this.handleChange
    };

    return (
      <div className="event_category-search">
        <p className="small-indent">Search for an existing Event Category</p>
        <Autosuggest
