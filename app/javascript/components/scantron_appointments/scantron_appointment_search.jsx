 ...
 */
class ScantronAppointmentSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/scantron_appointments/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Scantron Appointment name',
    ...
    return (
      <div className="scantron_appointment-search">
        <p className="small-indent">Search for an existing Scantron Appointment</p>
        <Autosuggest
...
export default ScantronAppointmentSearch;
