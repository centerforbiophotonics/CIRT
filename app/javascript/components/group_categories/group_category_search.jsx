 ...
 */
class GroupCategorySearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/group_categories/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Group Category name',
      value: this.state.search_text,
      onChange: this.handleChange
    };

    return (
      <div className="group_category-search">
        <p className="small-indent">Search for an existing Group Category</p>
        <Autosuggest
