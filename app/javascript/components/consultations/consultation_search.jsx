 ...
 */
class ConsultationSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/consultations/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Consultation name',
    ...
    return (
      <div className="consultation-search">
        <p className="small-indent">Search for an existing Consultation</p>
        <Autosuggest
