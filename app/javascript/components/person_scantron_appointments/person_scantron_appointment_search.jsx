 ...
 */
class PersonScantronAppointmentSearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/person_scantron_appointments/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Person Scantron Appointment name',
    ...
    return (
      <div className="person_scantron_appointment-search">
        <p className="small-indent">Search for an existing Person Scantron Appointment</p>
        <Autosuggest
...
export default PersonScantronAppointmentSearch;
