 ...
 */
class ConsultationCategorySearch extends React.Component {
  static propTypes = {
  ...
  onSuggestionsFetchRequested(){
    ...
    this.searchTimeout = setTimeout(() => {  
      var url = new URL(window.location.origin+"/consultation_categories/search");
  ...
  render(){
    const inputProps = {
      placeholder: 'Enter a Consultation Category name',
    ...
    return (
      <div className="consultation_category-search">
        <p className="small-indent">Search for an existing Consultation Category</p>
        <Autosuggest
...
export default ConsultationCategorySearch;
