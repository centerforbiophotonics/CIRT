...
class ConsultationCategoryForm extends React.Component {
  static propTypes = {
  ...
  constructor(props){
    ...
    this.state = {
      consultation_category: this.copy(this.props.consultation_category)
    }
  ...
  handleChange(e){
    ...
    this.setState(prevState => {
      prevState.consultation_category[name] = value;
      return prevState;
    });
  }
  ...
  handleDelete(e){
    ...
    if (confirm("Are you sure you want to delete this consultation_category?"))
      fetch("/consultation_categories/"+this.props.consultation_category.id, {
        method: 'DELETE',
   ...
   */
  valid(){
    let consultation_category = this.state.consultation_category;
    return true;
  }
  ...
  render(){
    ...
    let title = null;
    if (action == "create"){
      title = "Creating A New ConsultationCategory";
    } else if (action == "update"){
      title = "Editing " + consultation_category.name;
    }
        ...
        <div className="card-body">
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="name" name="name" aria-describedby="name_help" value={consultation_category.name} placeholder="Enter Name" onChange={this.handleChange}/>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="description" name="description" aria-describedby="description_help" value={consultation_category.description} placeholder="Enter Description" onChange={this.handleChange}/>
  ...
  componentWillReceiveProps(nextProps) {
    this.setState(prevState => {
      prevState.consultation_category = (nextProps.consultation_category ? this.copy(nextProps.consultation_category) : this.defaults());
      return prevState;
    })
  }
}

export default ConsultationCategoryForm;